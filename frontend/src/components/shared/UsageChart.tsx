...
function ChartTooltip({ active, payload, label }: any) {
  ...
  return (
    <div className="px-3 py-2.5 rounded-xl text-xs font-body" style={{ background: 'rgba(19,19,31,0.98)', border: '1px solid rgba(153,69,255,0.25)', boxShadow: '0 4px 20px rgba(0,0,0,0.4)' }}>
      ...
      <AreaChart data={chartData} margin={{ top: 4, right: 4, left: 0, bottom: 0 }}>
        <defs>
          <linearGradient id="storageGradient" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%" stopColor="#9945FF" stopOpacity={0.15} />
        ...
        <Area type="monotone" dataKey="bytes" stroke="#9945FF" strokeWidth={2} fill="url(#storageGradient)" dot={false} activeDot={{ r: 4, fill: '#9945FF', stroke: '#fff', strokeWidth: 1.5 }} />
      </AreaChart>
    </ResponsiveContainer>
  )
}
