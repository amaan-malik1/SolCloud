...
var ICONS = {
  add: async () => (await import("./add-JUFRAJDM.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-52KUBIOE.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-NZ3DJPQE.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-NCNNTGDF.js")).appStoreSvg,
  apple: async () => (await import("./apple-WTWEQARU.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-VCS35YZO.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-NFPINK6Q.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-TVTJXWGL.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-MNDKAMGX.js")).arrowTopSvg,
  bank: async () => (await import("./bank-Z35JMSJH.js")).bankSvg,
  browser: async () => (await import("./browser-DV2SENBW.js")).browserSvg,
  card: async () => (await import("./card-SHGS6CIV.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-BG2G2SSC.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-7MMW5WPI.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-VCQJHKUK.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-ROIVFANI.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-WHS4SSY2.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-IBSN3L5I.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-HSNR4SC5.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-R4FC3HEO.js")).clockSvg,
  close: async () => (await import("./close-DL3HW2L2.js")).closeSvg,
  compass: async () => (await import("./compass-C4Q5F3US.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-B5MDAUJH.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-46CC3Q4S.js")).copySvg,
  cursor: async () => (await import("./cursor-ZRKASQK7.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-Y5EFW7NV.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-FMBC2RR2.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-74M6IWZT.js")).disconnectSvg,
  discord: async () => (await import("./discord-E7OKBFKK.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-KOU3XZKQ.js")).etherscanSvg,
  extension: async () => (await import("./extension-J3X6BR5S.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-F62KM7GU.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-J55RNQDD.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-P4MIUKK6.js")).farcasterSvg,
  filters: async () => (await import("./filters-Z2YZKDZX.js")).filtersSvg,
  github: async () => (await import("./github-U4HP6NZN.js")).githubSvg,
  google: async () => (await import("./google-3ZDG45KM.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-FTMDIRTI.js")).helpCircleSvg,
  image: async () => (await import("./image-2HAWKAZ7.js")).imageSvg,
  id: async () => (await import("./id-M4GGUTA7.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-KKZL5LLN.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-MNPD3ZOY.js")).lightbulbSvg,
  mail: async () => (await import("./mail-ITIO6PIM.js")).mailSvg,
  mobile: async () => (await import("./mobile-ZCKL6UTY.js")).mobileSvg,
  more: async () => (await import("./more-6PYZERX7.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-D3MLEQD6.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-HSAP7KTQ.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-PSABJXF2.js")).offSvg,
  playStore: async () => (await import("./play-store-6335LDGZ.js")).playStoreSvg,
  plus: async () => (await import("./plus-WSYER33M.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-WFY6SCZT.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-3ANACPOI.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-POU5BMIK.js")).refreshSvg,
  search: async () => (await import("./search-GKY5AQNU.js")).searchSvg,
  send: async () => (await import("./send-RVZAV36H.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-ORS3LORH.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-NFM6YQ6Y.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-MMAWPW7P.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-CGHSEZLW.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-KNO7PRC5.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-TKLLKNAV.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-IE4TFODM.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-OCBDMWCC.js")).twitchSvg,
  twitter: async () => (await import("./x-OEMQFEKW.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-ILYZYYNY.js")).twitterIconSvg,
  verify: async () => (await import("./verify-LH53RHFI.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-GJ6IYVYV.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-7GAN5IKX.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-7LYUZ3WC.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-7LYUZ3WC.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-7LYUZ3WC.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-XO34BTQY.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-7GXZUOJT.js")).warningCircleSvg,
  x: async () => (await import("./x-OEMQFEKW.js")).xSvg,
  info: async () => (await import("./info-ANL4ZXQS.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-XPNAOHMP.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-BLDD5NG4.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-63N5VLRW.js.map
